...
# tau1 imports are optional - only needed for legacy _call_to_action_sglang method
try:
...
class OpenAICompatibleToolCallAdapter:
    ...
    def _call_to_action_sglang(self, calls: List[Any], text_response: str):
        ...
        Note: Requires tau1 (tau_bench) to be installed.
        """
        if not TAU1_AVAILABLE or Action is None:
            raise ImportError("tau1 (tau_bench) is required for _call_to_action_sglang. Install with: pip install tau-bench")
